...
<section class="container" style="margin-top: 1%; margin-bottom: 2%;">
       <div class="row">
          ...
          <div class="col-md-6 why6">
               <h3 >¿De qué forma Lexium apoya a mi departamento / servicio?</h3>
               <div class="row">
                    <div class="col-md-6">
                      <div class="row">
                           <div class="w-100 p-3" >
                           ...
                           <div class="w-100 p-3 whytxt">
                                <h6 style="font-family: 'HarmoniaSansW01-Regular'; color: #23215b; font-size: 1.3em;">Rapidez para identificar el perfil de aprendizaje de cada persona.</h6>
                           </div>
                      </div>
                    </div>
                    <div class="col-md-6">
