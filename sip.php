...
<div class="tools generic_page">
        ...
        <div class="x-space">
            <div class="row d-flex align-items-center">
                <div class="col-md-8 col-lg-6">
                    <h1><?php lang('SIP_001');?></h1>
                    <p><?php lang('SIP_002');?></p>
    ...
    <section class="pt-5 principal_container">
        <div class="container">
            <h3 class="mt-5"><?php lang('SIP_004');?></h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <iframe src="https://player.vimeo.com/video/368912124" width="100%" height="250" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                </div>
            </div>
        </div>
