            	...
            	<div class="col-md-6 datasgral">
	   	    	 	  <div class="row">
	   	    	 	        ...
	   	    	 	        <div class="col-md-8 col-6">
                                 <h5>Individual</h5>
                                 <p>Conoce el perﬁl de habilidades de cada persona evaluada en relación a la evaluación aplicada.</p>
	   	    	 ...
	   	    	 <div class="col-md-6 datasgral">
	   	    	 	  <div class="row">
	   	    	 	        ...
	   	    	 	        <div class="col-md-8 col-6 orderdata4">
                                 <h5>Perfil y Potencial de Aprendizaje</h5>
                                 <p>Consulta fácilmente el diagnóstico global de una persona.</p>
             ...
             <div class="line"></div>
	   	    	 ...
	   	    	 <div class="col-md-6 datasgral">
	   	    	 	  <div class="row">
	   	    	 	        ...
	   	    	 	        <div class="col-md-8 col-6">
                                 <h5>Personalizado</h5>
                                 <p>Involucra a cada persona evaluada en un proceso de autoconocimiento y desarrollo intencionado.</p>
             ...
             <div class="line"></div>
	   	    	 ...
	   	    	 <div class="col-md-6 datasgral">
	   	    	 	  <div class="row">
	   	    	 	        ...
	   	    	 	        <div class="col-md-8 col-6 orderdata4">
                                 <h5>Grupal</h5>
                                 <p>Potencia al docente con una tabla grupal que muestra las habilidades de aprendizaje de los alumnos y el grupo conjunto.</p>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <img class="img-fluid" src="./resources/images/diagnostico/diagnostico_individual.png" alt="Individual" title="Individual">
      </div>
