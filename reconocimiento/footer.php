            ...
            <div class="container">
                ...
                <div class="row mt-5">
                  <div class="col-md-6 mb-5">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <a href="../skillmap.php">» <?php lang('Skill Map');?></a></a>
                        <ul>
                      ...
                      <div class="col-lg-6">
                        <a href="../skillmt.php">» <?php lang('Skill Map & Training');?></a>
                        <ul>
                    ...
                    <a href="../sip.php">» <?php lang('Sistema de ingreso y permanencia');?></a>
                    <ul>
                  ...
                  <div class="col-md-3 mb-5">
                      ...
                      <a href="../confianza.php">» <?php lang('Clientes');?></a>
                      <a href="../nuestros_clientes_opinan.php">» <?php lang('Testimonios');?></a>
                      <a href="../valores.php">» <?php lang('Apoyo Social');?></a>
                  </div>
                  <div class="col-md-3 mb-5">
                      <h3><?php lang('Más');?></h3>
                      ...
                      <a href="../contacto.php">» <?php lang('Contacto');?></a>
                  </div>
                </div>
            </div>
