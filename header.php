    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-blue">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse" style="">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo 'index.php' ?>"><?php lang('Inicio');?> <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-itemdropdown" style="position: relative;">
              ...
              <div class="dropdown-menu sub-menu-bg-blue" aria-labelledby="dropdown01">
                ...
                <a class="dropdown-item" href="<?php echo 'skillmt.php'?>">» <?php lang('Skill Map & Training');?></a>
                <ul>
                  <li><a href="<?php echo 'skillmap.php'?>"><?php lang('Skill Map');?></a></li>
                  <li><a href="<?php echo 'skillmt.php#trainig'?>"><?php lang('Entrenamiento');?></a></li>
                </ul>
          ...
          <li class="nav-itemdropdown" style="position: relative;">
              ...
              <div class="dropdown-menu sub-menu-bg-blue" aria-labelledby="dropdown01">
                <a class="dropdown-item" href="<?php echo 'confianza.php'?>">» <?php lang('Clientes');?></a>
                <a class="dropdown-item" href="<?php echo 'nuestros_clientes_opinan.php'?>">» <?php lang('Testimonios');?></a>
                <a class="dropdown-item" href="<?php echo 'valores.php'?>">» <?php lang('Apoyo Social');?></a>
              </div>
          </li>
          <!--<li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo 'contacto.php'?>"><?php lang('Contacto');?></a>
          </li>
          <li class="nav-item">
