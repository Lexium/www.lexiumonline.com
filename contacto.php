...
<?php include('header.php'); ?>
      <section class="sub-header d-flex align-items-center justify-content-center">
        <h1><?php lang('CON_001');?></h1>
      </section>
      <section class="b2_map">
        <div class="container py-5">
          <h2><?php lang('CON_002');?></h2>
          <div class="row">
            <div class="col-md-6">
              <p><?php lang('CON_003');?></p>
              <div class="form">
                ...
                <input type="hidden" value="-1" name="validacion" id="validacion">
                  <div class="form-group">
          						<input type="text" name="name" class="form-control" placeholder="<?php lang('CON_004');?>" value="<?php echo (isset($_POST ['name']) ? $_POST['name'] : ''); ?>">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" name="message" rows="5" placeholder="<?php lang('CON_005');?>"><?php echo (isset($_POST ['message']) ? $_POST['message'] : ''); ?></textarea>
          ...
          <div class="form-group">
            <p>En dónde te encontramos</p>
				  ...
				  <div class="form-row">
  					...
  					<div class="form-group col-md-6">
  					  <input type="email" name="email" class="form-control" placeholder="<?php lang('CON_006');?>" value="<?php echo (isset($_POST ['email']) ? $_POST['email'] : ''); ?>">
            ...
            <?php endif; ?>
  					...
  					<div class="form-group col-md-6">
  					  <input type="text" name="phone" class="form-control" placeholder="<?php lang('CON_007');?>" value="<?php echo (isset($_POST ['phone']) ? $_POST['phone'] : ''); ?>" required="" minlength="9" onkeypress="return valida(event)">
				  ...
				  <div class="form-row">
                    ...
                    <div class="form-group col-md-6 text-right">
                      ...
                      <button type="submit" class="btn btn-primary"><?php lang('CON_008');?></button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="col-md-6">
              <br/><br/><br/>
              <p><?php lang('CON_009');?></p>
              <h5><?php lang('CON_010');?></h5>
              <p>
